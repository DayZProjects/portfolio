...
function Skills() {
  return (
    ...
    <div className="max-w-4xl mt-20 mx-auto">
        ...
        Начнём с продажи. Я продам квартиру, частный дом, участок, гараж. При этом совершенно не важно, какая у тебя ситуация. Разберусь с любой, будь то наследство, опека, обременение либо долги. И это будет абсолютно безопасно для тебя. Даже если тебе нужно продать и сразу же купить жильё, без крыши над головой ты не останешься. Оплата моих услуг фиксированная -3%, от суммы продажи но не менее 60к. Во время продажи тебе нужно будет расслабиться и получать удовольствие, потому что я сделаю все сам. Тебе останется только прийти на сделку.
